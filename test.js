...
describe("Compound Simulation", function () {
	...
	const USDCAddress = "0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48";
  	...
  	const godAddress = "0x0A59649758aa4d66E25f08Dd01271e891fe52199"; 
	...
	//***[Print] the USDC balance in the Compound USDC contract
  	...
  	await network.provider.send("hardhat_setBalance", [ godAddress, "0x10000000000000000000000000000000", ]);  //give god enough ethers, or it will fail for paying gas
  	await USDCContractGod.transfer(aliceAddress, 1000*10**6);   //give Alice 1000usdc
  	...
  	await compoundContractBob.supply(WETHAddress, amountToSave);   //Bob supply a lot of amount of WETH to compound contract
  	await compoundContractBob.withdraw(USDCAddress, totalBalance);  //withdraw all the USDC from the compound contract
	...
	console.log("******WETH: ",await WETHContractBob.balanceOf(compoundAddress)/(10**6));
  	...
  	await expect (compoundContractAlice.withdraw(USDCAddress, 1000*10**6)).to.be.revertedWith("ERC20: transfer amount exceeds balance");
    });
